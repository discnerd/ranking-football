...
scores <- read.csv("https://www.masseyratings.com/scores.php?s=308075&sub=11620&all=1&mode=2&format=1", header=FALSE)
teams <- read.csv("https://www.masseyratings.com/scores.php?s=308075&sub=11620&all=1&mode=2&format=2", header=FALSE)
...
write.csv(rankedteams, paste("2019 Rankings/D3 MOV RW ", format(Sys.time(),"%Y %m %d"),".csv",sep=""), row.names = FALSE)
