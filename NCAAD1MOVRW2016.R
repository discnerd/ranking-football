...
scores <- read.csv("http://www.masseyratings.com/scores.php?s=286577&sub=11590&all=1&mode=2&format=1", header=FALSE)
teams <- read_csv("http://www.masseyratings.com/scores.php?s=286577&sub=11590&all=1&mode=2&format=2", col_names = FALSE)
...
FBSteams <- read_csv("http://www.masseyratings.com/scores.php?s=286577&sub=11604&all=1&mode=2&format=2", col_names=FALSE)
