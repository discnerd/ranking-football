...
library(readr)
write_csv(rankedteams, paste("2018 Rankings/D1 MOV RW ", format(Sys.time(),"%Y %m %d"),".csv",sep=""))
...
write.csv(FBSRanking, paste("2018 Rankings/D1-FCS MOV RW ", format(Sys.time(),"%Y %m %d"),".csv",sep=""), row.names = FALSE)
