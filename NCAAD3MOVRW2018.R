...
scores <- read.csv("https://www.masseyratings.com/scores.php?s=300937&sub=11620&all=1&mode=2&format=1", header=FALSE)
teams <- read.csv("https://www.masseyratings.com/scores.php?s=300937&sub=11620&all=1&mode=2&format=2", header=FALSE)
