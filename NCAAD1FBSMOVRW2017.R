...
library(readr)
pFG<-0.2288083 #Need to add NoPAT and 2PT for D3 because the game is different
#pTD<-1-pFG
pTDnoPA<-0.0470239
pTDPA<-0.7103081
pTD2P<-0.0138597
...
scores <- read.csv("https://www.masseyratings.com/scores.php?s=295489&sub=11604&all=1&mode=2&format=1", header=FALSE)
teams <- read_csv("https://www.masseyratings.com/scores.php?s=295489&sub=11604&all=1&mode=2&format=2", col_names = FALSE)
